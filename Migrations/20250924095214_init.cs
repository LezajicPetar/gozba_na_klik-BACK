...
namespace gozba_na_klik.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "LastName", "Password", "ProfilePicture", "Role" },
                values: new object[,]
                {
                    { 1, "admin1@gozba.com", "Admin", "One", "admin123", null, 0 },
                    { 2, "admin2@gozba.com", "Admin", "Two", "admin123", null, 0 },
                    { 3, "admin3@gozba.com", "Admin", "Three", "admin123", null, 0 }
                });
