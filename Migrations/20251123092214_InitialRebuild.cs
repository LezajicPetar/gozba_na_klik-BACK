        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_WorkTimes_DayOfWeek_Range", "\"DayOfWeek\" >= 0 AND \"DayOfWeek\" <= 6");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CurrentOrderId", "Email", "FirstName", "LastName", "PasswordHash", "ProfilePicture", "Role", "Username", "isActive" },
                values: new object[,]
                {
                    { 1, null, "admin1@gozba.com", "Admin", "One", "$2a$12$97Po1ExL9B3PTNSyDYBlmetfcdxQNuLWdRQ06l.A8eC0pJ9s6Zee2", null, "Admin", "Admin1", true },
                    { 2, null, "admin2@gozba.com", "Admin", "Two", "$2a$12$97Po1ExL9B3PTNSyDYBlmetfcdxQNuLWdRQ06l.A8eC0pJ9s6Zee2", null, "Admin", "Admin2", true },
                    { 3, null, "admin3@gozba.com", "Admin", "Three", "$2a$12$97Po1ExL9B3PTNSyDYBlmetfcdxQNuLWdRQ06l.A8eC0pJ9s6Zee2", null, "Admin", "Admin3", true }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_Role_IsActive_IsBusy",
                table: "Users",
                columns: new[] { "Role", "isActive", "IsBusy" });
